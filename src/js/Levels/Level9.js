...
class Level9 extends BaseLevel {
  ...
  game = {
    ...
    start() {
      ...
      this.myObjects.slidingWall2 = Matter.Bodies.rectangle((this.game.settings.width / 2) - 300, (this.game.settings.height / 2) - 150, 20, 600, {
        isStatic: true,
        restitution: 1,
        render: {
          visible: true,
      ...
      this.myObjects.slidingWall3 = Matter.Bodies.rectangle((this.game.settings.width / 2) + 300, (this.game.settings.height / 2) - 150, 20, 600, {
        isStatic: true,
        restitution: 1,
        render: {
          visible: true,
      ...
      Matter.World.add(this.game.engine.world, [this.myObjects.slidingWall, this.myObjects.slidingWall2, this.myObjects.slidingWall3, this.myObjects.slidingWall4]);
    }
